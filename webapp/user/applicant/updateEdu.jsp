    ...
    <div class="resume_main">
        ...
        <div class="resume_left">
            ...
            <div class="all_resume">
                ...
                <form action="${pageContext.request.contextPath}/updateEdusecond?edu_id=${edu.edu_id}" method="post">

                    <div class="table_style">
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                <th width="110" align="right" bgcolor="#F8F8F8">毕业院校：</th>
                                <td bgcolor="#F8F8F8"><input type="text" name="edu_college" value="${edu.edu_college}"></td>
                            </tr>
                        </table>
                        ...
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                ...
                                <td bgcolor="#F8F8F8"><input type="text" name="edu_time" value="${edu.edu_time}"></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                ...
                                <td bgcolor="#F8F8F8"><input type="text" name="edu_zhuanye" value="${edu.edu_zhuanye}"></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        <div style="margin-left:100px;"><input name="" type="submit" class="save1" value="确定">
