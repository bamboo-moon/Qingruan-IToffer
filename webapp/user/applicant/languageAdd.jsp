                    ...
                    <div class="table_style">
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                ...
                                <td bgcolor="#F8F8F8"><input type="text" name="lan_name" value=""></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                ...
                                <td bgcolor="#F8F8F8"><input type="text" name="lan_listen" value=""></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        ...
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                ...
                                <td bgcolor="#F8F8F8"><input type="text" name="lan_write" value=""></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        ...
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                ...
                                <td bgcolor="#F8F8F8"><input type="text" name="lan_level" value=""></td>
                            </tr>
                        </table>
                        <div class="he"></div>

                        <div style="margin-left:100px;"><input name="" type="submit" class="save1" value="保存">
                            <%--<a class="cancel2" href="${pageContext.request.contextPath}/user/applicant/resume.jsp">取消</a>--%>
