    ...
    <div class="resume_main">
        ...
        <div class="resume_left">
            ...
            <div class="all_resume">
                ...
                <form action="${pageContext.request.contextPath}/updateExjobsecond?exjob_id=${exjob.exjob_id}" method="post">

                    <div class="table_style">
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                <th width="110" align="right" bgcolor="#F8F8F8">工作公司：</th>
                                <td bgcolor="#F8F8F8"><input type="text" name="exjob_loc" value="${exjob.exjob_loc}"></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                ...
                                <td bgcolor="#F8F8F8"><input type="text" name="exjob_time" value="${exjob.exjob_time}"></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        ...
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                ...
                                <td bgcolor="#F8F8F8"><input type="text" name="exjob_name" value="${exjob.exjob_name}"></td>
                            </tr>
                        </table>
                        <div class="he"></div>
