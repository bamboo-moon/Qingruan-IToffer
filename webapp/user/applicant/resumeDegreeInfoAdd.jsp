    ...
    <div class="resume_main">
	    ...
	    <div class="resume_left">
			...
			<div class="all_resume">
				<form action="${pageContext.request.contextPath}/saveUserDegree" method="post" >
				<div class="table_style">
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    <th width="110" align="right" bgcolor="#F8F8F8">毕业院校：</th>
					    <td bgcolor="#F8F8F8"><input type="text" name="eduCollege" value=""></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    <th width="110" align="right" bgcolor="#F8F8F8">就读时间：</th>
						  <td bgcolor="#F8F8F8"><input type="text" name="eduTime" value=""></td>
					    </tr>
					</table>
					<div class="he"></div>
					...
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="eduZhuanye" value=""></td>
					  </tr>
					</table>
