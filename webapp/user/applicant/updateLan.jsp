    ...
    <div class="resume_main">
        ...
        <div class="resume_left">
            ...
            <div class="all_resume">
                ...
                <form action="${pageContext.request.contextPath}/updateLansecond?lan_id=${lan.lan_id}" method="post">

                    <div class="table_style">
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                <th width="110" align="right" bgcolor="#F8F8F8">语言：</th>
                                <td bgcolor="#F8F8F8"><input type="text" name="lan_name" value="${lan.lan_name}"></td>
                            </tr>
                        </table>
                        ...
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                <th width="110" align="right" bgcolor="#F8F8F8">听说：</th>
                                <td bgcolor="#F8F8F8"><input type="text" name="lan_listen" value="${lan.lan_listen}"></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                <th width="110" align="right" bgcolor="#F8F8F8">读写：</th>
                                <td bgcolor="#F8F8F8"><input type="text" name="lan_write" value="${lan.lan_write}"></td>
                            </tr>
                        </table>
                        <div class="he"></div>
                        <table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
                            <tr>
                                <th width="110" align="right" bgcolor="#F8F8F8">等级考试：</th>
                                <td bgcolor="#F8F8F8"><input type="text" name="lan_level" value="${lan.lan_level}"></td>
                            </tr>
                        </table>
                        <div class="he"></div>
